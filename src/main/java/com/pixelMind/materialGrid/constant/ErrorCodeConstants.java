...
public final class ErrorCodeConstants {
    ...
    public static final String PRICE_RATE_NOT_FOUND = "PRICE_RATE_NOT_FOUND";
    ...
    public static final String DUPLICATE_VEHICLE_NUMBER = "DUPLICATE_VEHICLE_NUMBER";
    public static final String LICENSE_NOT_FOUND = "LICENSE_NOT_FOUND";
    public static final String DUPLICATE_LICENSE_CODE = "DUPLICATE_LICENSE_CODE";
